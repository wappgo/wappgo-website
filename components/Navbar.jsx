...
// // ... keep your dynamic imports the same ...
...
//     height: "20px",
//   }), [dropdowns.services]);
//   // New function to handle mobile navigation
//   const handleMobileNavigation = useCallback((e, href) => {
//     e.preventDefault();
//     closeAllDropdowns();
//     router.push(href);
//   }, [closeAllDropdowns, router]);

//   // ... keep your roateiconStyle and useGSAP the same ...
...
//       <nav className="navbar">
//         <div className="navbar-container navbar-container-border">
//           {/* ... keep your logo and mobile menu button the same ... */}
//           <div className="logo">
//            <Link href="/" prefetch>
//               <Image 
//                 src='/assets/wappgologo1.svg' 
...
//           <ul className={`nav-links ${dropdowns.mobileMenu ? 'mobile-menu-active' : ''}`}>
//             <li className={pathname === "/" ? "activepath" : "active-item"}>
//               <Link href="/" onClick={(e) => dropdowns.mobileMenu && handleMobileNavigation(e, "/")}>
//                 Home
//               </Link>
//             </li>
//             <li
//               onMouseEnter={() => !dropdowns.mobileMenu && handleDropdown('services', true)}
//               onClick={() => dropdowns.mobileMenu && handleDropdown('services', !dropdowns.services)}
//               className="active-item"
//             >
//               Services
//               <FaChevronDown style={roateiconStyle} />
//             </li>
//             <li
//               onMouseEnter={() => !dropdowns.mobileMenu && handleDropdown('industries', true)}
//               onClick={() => dropdowns.mobileMenu && handleDropdown('industries', !dropdowns.industries)}
//               className="active-item"
//             >
//               Industries
//             </li>
...
//                 href="/letsdiveintoAI" 
//                 className="active" 
//                 onClick={(e) => dropdowns.mobileMenu && handleMobileNavigation(e, "/letsdiveintoAI")}
//               >
//                 <span className="gradient-text">Let's Dive Into AI</span>
//               </Link>
//             </li>
...
//               <Link 
//                 href="/case-study" 
//                 onClick={(e) => dropdowns.mobileMenu && handleMobileNavigation(e, "/case-study")}
//               >
//                 Case studies
//               </Link>
//             </li>

//             {/* ... keep your NoExpose item the same ... */}

//             <li className={pathname === "/about" ? "activepath" : "active-item"}>
//               <Link 
//                 href="/about" 
//                 onClick={(e) => dropdowns.mobileMenu && handleMobileNavigation(e, "/about")}
//               >
//                 About us
//               </Link>
//             </li>
...
//               <Link 
//                 href="/career" 
//                 onClick={(e) => dropdowns.mobileMenu && handleMobileNavigation(e, "/career")}
//               >
//                 Careers
//               </Link>
//             </li>
...
//           </ul>
//           {!dropdowns.mobileMenu && (
//             <Link href="/contact" className="desktop-contact-btn" onClick={closeAllDropdowns}>
//               Contact Us
//             </Link>
//           )}
//         </div>
//       </nav>
//       {/* ... keep your dropdown components the same ... */}
//     </>
//   );
// };
